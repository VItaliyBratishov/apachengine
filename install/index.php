...
<head>
  ...
  <style>
	...
	input.input {width: 856px; border: .2rem solid #444; margin-bottom: 1px;}
  ...
  <main>
    ...
    <nav>
      <ul>
        ...
        <li><a href="https://github.com/splincode/apachengine">Github</a></li>
      </ul>
    </nav>
	<br>
	...
	<section>
		...
		<form action="/index.php" method="post" target="blank">
			<input class="input" type="text" placeholder="Название" name="createdomain">
		...
		<script>
			...
			$('.okpas').click(function(){
				...
				$.ajax({
				  type: "POST",
				  data: "createdomain="+$domain+"&password="+$pass,
				  url: "index.php",
				  success: function(a){
